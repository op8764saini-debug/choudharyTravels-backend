...
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
  ...
  <div class="card">
    <div class="card-body">
      ...
      <form class="forms-sample" action="{{ route('blog_create_post') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="date" id="custom-date-picker">
        ...
        <a href="{{route('admin_blog')}}" class="btn btn-primary">Cancel</a>
      </form>
    </div>
  </div>
