            ...
            <div class="container text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <h1 class="mb-4 text-dark">Thank You For Contacting Us</h1>
                        <h3 class="mb-4 text-dark">Stay Connected, Anytime, Anywhere!</h3>
                        <p class="mb-4 text-dark">Thank you for reaching out. We have received your submission.</p>
